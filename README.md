...
![Визуализация распределения цен (drink_price и total_cost)](docs/figures/drink_price&total_cost_inver.png)
...
![Продажи по времени дня (time_of_day)](docs/figures/time_of_day_inver.png)

#### **Продажи по дням недели**

*   Наибольшая активность продаж наблюдается в будние дни. В выходные количество заказов снижается.

![Анализ по дням недели (is_weekend и day_name)](docs/figures/is_weekend&day_name_inver.png)
![Анализ по дням недели (is_weekend и day_name)](docs/figures/heatmap_inver.png)

Нагрузка на персонал кофейни по дням и часам
![Пиковая нагрузка (транзакций/час)](docs/figures/staffing_load_matrix.png)
![Временной анализ (нагрузка и планирование персонала)](docs/figures/hourly_sales_inver.png)
...
![Методы оплаты](docs/figures/payment_method_inver.png)
...
*   Выявлена группа регулярных покупателей, для которых целесообразно внедрение программы лояльности.
 ...
 ![Анализ клиентов (топ-клиенты по тратам)](docs/figures/customer_id_inver.png)
